...
class DiscoDaoImplTest {
    ...
    void save() {
        ...
        disco.setTitulo("Disco test");
        disco.setPrecio(0.8F);
        disco.setExistencia(43);
        disco.setDescuento(0.6F);
...
GeneroMusicalDao generoMusicalDao = GeneroMusicalDaoImpl.getInstance();
        ...
        assertEquals("Disco test", discoGuardado.getTitulo()  );
    }

    @Test
    void update() {
        DiscoDao discoDao = DiscoDaoImpl.getInstance();
        Disco disco = discoDao.findById(7);
        ...
        Disco discoActualizado = discoDao.findById(7);
    ...
    void delete() {
        ...
        Disco discoEliminado = discoDao.findById(7);
    ...
    void findById() {
        ...
        assertEquals(7, disco.getId(), "El ID del disco no coincide");
        assertEquals("Disco actualizado", disco.getTitulo(), "El nombre del disco no coincide");
    }
}